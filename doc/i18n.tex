...
\begin{figure}
  ...
  \psfrag{TaskTracker.py}{\tt TaskTracker.py}
  \psfrag{TaskTracker\_view.xml.en}{\tt TaskTracker\_view.xml.en}
  \psfrag{1. igettext.py}{1. \tt igettext.py} 
  \psfrag{2. igettext.py}{2. \tt igettext.py} 
  \psfrag{3. igettext.py}{3. \tt igettext.py} 
  \psfrag{TaskTracker\_view.xml.es}{\tt TaskTracker\_view.xml.es}
  \psfrag{es.po}{\tt es.po} 
  \psfrag{es.mo}{\tt es.mo} 
