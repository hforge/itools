...
an space after the opening bracket, and another space before the closing
bracket.

The comma and colon must be followed by an space (or a new line), but never
put an space before. The only exception is for one element tuples, where
