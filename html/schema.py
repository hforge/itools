...
html_elements = [
    ...
    BlockElement('form', common_attrs + ['action', 'method', 'enctype',
        'onsubmit', 'onreset', 'accept', 'accept-charset']),
    ...
    ImgElement('img', common_attrs + ['src', 'alt', 'longdesc', 'height',
        ...
        'vspace']),
    InputElement('input', core_attrs + ['type', 'name', 'value', 'checked',
        'disabled', 'readonly', 'size', 'maxlength', 'src', 'alt', 'usemap',
    ...
    BlockElement('script', ['charset', 'type', 'src', 'defer'],
