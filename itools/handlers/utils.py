...
src = (ur"""ÄÅÁÀÂÃĀäåáàâãāăČÇçÉÈÊËĒéèêëēğÍÌÎÏĪíìîïīıļÑñÖÓÒÔÕØŌöóòôõøōőÜÚÙÛŪüúùûū"""
       ur"""ŞşšţÝŸȲýÿȳŽž°«»’""")
dst = (ur"""AAAAAAAaaaaaaaaCCcEEEEEeeeeegIIIIIiiiiiilNnOOOOOOOooooooooUUUUUuuuuu"""
       ur"""SsstYYYyyyZz----""")
