...
src = (ur"""ÄÅÁÀÂÃĀäåáàâãāăČÇçÉÈÊËĒéèėêëēğÍÌÎÏĪíìîïīıļÑñÖÓÒÔÕØŌöóòôõøōőÜÚÙÛŪüúùûū"""
       ur"""ŞşšţÝŸȲýÿȳŽž°«»’""")
dst = (ur"""AAAAAAAaaaaaaaaCCcEEEEEeeeeeegIIIIIiiiiiilNnOOOOOOOooooooooUUUUUuuuuu"""
       ur"""SsstYYYyyyZz----""")
